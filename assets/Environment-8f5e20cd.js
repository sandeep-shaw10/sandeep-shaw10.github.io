import{w as O,ao as X,ah as J,D as K,ap as Q,al as S,an as C,aq as U,ar as W,l as j,a as x,as as Z,at as ee,b as re,au as te,av as ne,_ as oe,u as ae,aw as ie,ax as se,s as ce,ay as le}from"./OrbitControls-f1eb722f.js";import{r as h}from"./index-34bb0670.js";const ue=r=>r&&r.isCubeTexture;class de extends O{constructor(a,i){var u,d;const o=ue(a),_=((u=o?(d=a.image[0])===null||d===void 0?void 0:d.width:a.image.width)!=null?u:1024)/4,p=Math.floor(Math.log2(_)),v=Math.pow(2,p),I=3*Math.max(v,16*7),T=4*v,k=[o?"#define ENVMAP_TYPE_CUBE":"",`#define CUBEUV_TEXEL_WIDTH ${1/I}`,`#define CUBEUV_TEXEL_HEIGHT ${1/T}`,`#define CUBEUV_MAX_MIP ${p}.0`],P=`
